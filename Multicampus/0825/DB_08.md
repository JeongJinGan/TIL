...
```python
query = Director.objects.get(name='봉준호')
print(f' id : {query.id}')
print(f' name : {query.name}')
print(f' debut : {query.debut}')
...
```python
query = Genre.objects.get(title='드라마')
print(f' id : {query.id}')
...
for data in movies:
    movie = Movie()
    movie.director = Director.objects.get(name=data[0])
    movie.genre = Genre.objects.get(title=data[1])
    movie.title = data[2]
...
```python
data = Movie.objects.all().order_by('opening_date')[0]
print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
...
```python
for data in Movie.objects.filter(screening = True).order_by('opening_date'):
    print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
...
```python
query = Director.objects.get(name='봉준호').id
for data in Movie.objects.filter(director = query).order_by('opening_date'):
    print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
...
```python
query = Director.objects.get(name='봉준호').id
data = Movie.objects.filter(director = query).order_by('opening_date')[1]
print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
...
```python
for data in Movie.objects.filter(running_time__gt = 119).order_by('running_time'):
    print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
...
```python
for data in Movie.objects.filter(running_time__gte = 119).order_by('running_time'):
    print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
...
```python
for data in Movie.objects.filter(opening_date__gt = '2022-01-01').order_by('opening_date'):
    print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
...
```python
query = Director.objects.get(name='봉준호').id
query2 = Genre.objects.get(title='드라마').id
for data in Movie.objects.filter(director = query, genre = query2).order_by('opening_date'):
    print(data.director.name, data.genre.title, data.title, data.opening_date, data.running_time, data.screening)
```
